...
public class employeeSalary3 extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	...
	query="select e.employee_id,e.employee_name,s.salary from salary s, employee e where e.Employee_ID=s.Employee_ID and e.designation='"+info+"'";
