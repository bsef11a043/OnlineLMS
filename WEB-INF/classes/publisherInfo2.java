...
public class publisherInfo2 extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	...
	out.println("</div><div id='content' style='background-color:99FFFF;height:450px;width:955px;float:left;'><h2><b>Publisher Information</b></h2><br>");
	...
	String query;
	out.println("<table border=5 align='center' bordercolor='#6699FF'><tr><td>ID</td><td> Name</td><td> Address</td><td> Phone No.</td><td> Email </td></tr>");
	
	query="select * from publisher where publisher_name='"+info+"'";
	...
	while(res.next())
	{
		...
		out.println("<tr><td>"+id+"</td><td>"+name+"</td><td>"+address+"</td><td>"+phn+"</td><td>"+email+"</td></tr>");
	}
	out.println("</table>");
	out.println("<br><a href='publisherInfo.html'>Go Back</a>");
